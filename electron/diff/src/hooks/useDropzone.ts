 ...
 * @param {string} [options.accept] - Accepted file types (HTML input accept format)
...
export const useDropzone = ({
	...
	const getInputProps = useCallback(
		...
		[allowMultiple, accept, handleInputClick, handleInputChange, disabled],
	);
	...
	useEffect(() => {
		if (dialogOnClick && dialogOnDoubleClick) {
			console.warn("Use either dialogOnClick or dialogOnDoubleClick, not both, to avoid double dialogs.");
		}
