...
impl LanguageID {
  ...
  pub fn as_ts_string(&self) -> &'static str {
    match self {
      ...
      LanguageID::Freemarker2TagAngleInterpolationDollar => {
        "freemarker2.tag-angle.interpolation-dollar"
      }
      LanguageID::Freemarker2TagBracketInterpolationDollar => {
        "freemarker2.tag-bracket.interpolation-dollar"
      }
      LanguageID::Freemarker2TagAngleInterpolationBracket => {
        "freemarker2.tag-angle.interpolation-bracket"
      }
      LanguageID::Freemarker2TagBracketInterpolationBracket => {
        "freemarker2.tag-bracket.interpolation-bracket"
      }
      LanguageID::Freemarker2TagAutoInterpolationDollar => {
        "freemarker2.tag-auto.interpolation-dollar"
      }
      LanguageID::Freemarker2TagAutoInterpolationBracket => {
